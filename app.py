...
@app.route('/student/delete/<int:student_id>') # creates a place holder student_id as a placeholder for the url
...
if __name__ == '__main__':
    with app.app_context():
        ...
        # Execute only once! Initial loading of available majors (will not run in PythonAnywhere)
        """
